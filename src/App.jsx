              ...
              {showAiImport && (
                <div style={{ background: 'rgba(168, 85, 247, 0.1)', border: '1px solid rgba(168, 85, 247, 0.3)', borderRadius: 12, padding: 16, marginBottom: 16 }}>
                  ...
                  <div style={{ display: 'flex', gap: 16, marginBottom: 12 }}>
                    <div style={{ flex: 1, fontSize: 12, color: 'rgba(233, 213, 255, 0.7)', background: 'rgba(0,0,0,0.2)', padding: 10, borderRadius: 8 }}>
                    ...
                    <div style={{ flex: 1, fontSize: 12, color: 'rgba(233, 213, 255, 0.9)', background: 'rgba(168, 85, 247, 0.15)', padding: 10, borderRadius: 8, border: '1px dashed rgba(168, 85, 247, 0.4)' }}>
                      <strong>Copy this prompt to ChatGPT/Gemini:</strong>
                      <div style={{ marginTop: 4, fontFamily: 'monospace', color: '#fff' }}>
                      ...
                      <button
                        ...
                        style={{ background: '#a855f7', color: '#fff', border: 'none', padding: '4px 8px', borderRadius: 4, fontSize: 11, marginTop: 8, cursor: 'pointer', fontWeight: 600 }}
                      >
                        Copy Prompt
                      </button>
                    </div>
